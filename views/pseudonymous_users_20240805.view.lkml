view: pseudonymous_users_20240805 {
  sql_table_name: `analytics_229525974.pseudonymous_users_20240805` ;;
...
view: pseudonymous_users_20240805__audiences {
  drill_fields: [id]
  ...
  dimension: pseudonymous_users_20240805__audiences {
    type: string
    hidden: yes
    sql: pseudonymous_users_20240805__audiences ;;
  }
}

view: pseudonymous_users_20240805__user_properties {

  dimension: key {
    type: string
    sql: key ;;
  }
  dimension: pseudonymous_users_20240805__user_properties {
    type: string
    hidden: yes
    sql: pseudonymous_users_20240805__user_properties ;;
  }
