view: pseudonymous_users_20240804 {
  sql_table_name: `analytics_229525974.pseudonymous_users_20240804` ;;
...
view: pseudonymous_users_20240804__audiences {
  drill_fields: [id]
  ...
  dimension: pseudonymous_users_20240804__audiences {
    type: string
    hidden: yes
    sql: pseudonymous_users_20240804__audiences ;;
  }
}

view: pseudonymous_users_20240804__user_properties {

  dimension: key {
    type: string
    sql: key ;;
  }
  dimension: pseudonymous_users_20240804__user_properties {
    type: string
    hidden: yes
    sql: pseudonymous_users_20240804__user_properties ;;
  }
